...
<div class="bg-white rounded-xl border border-gray-100 shadow-sm overflow-hidden">
  ...
  <?php if(empty($invoices)): ?>
    <div class="text-center py-16"><p class="text-3xl mb-3">🧾</p><p class="text-gray-500 font-medium">No invoices yet</p><a href="/crm/invoices/create" class="mt-3 inline-block text-amber-600 text-sm font-medium">+ Create first invoice</a></div>
  <?php else: ?>
    ...
    <tbody class="divide-y divide-gray-50">
      ...
      <tr class="hover:bg-gray-50">
        <td class="px-5 py-3.5">
          <a href="/crm/invoices/view?id=<?=$inv['id']?>" class="font-medium text-gray-900 hover:text-amber-600 font-mono"><?=htmlspecialchars($inv['invoice_number'])?></a>
