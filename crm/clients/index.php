...
$page_title = 'Clients';
$active_nav = 'clients';
$header_actions = '<a href="/crm/clients/create"
...
<div class="bg-white rounded-xl border border-gray-100 shadow-sm overflow-hidden">
  ...
  <?php if (empty($clients)): ?>
    <div class="text-center py-16">
      ...
      <a href="/crm/clients/create" class="mt-3 inline-block text-amber-600 hover:text-amber-700 text-sm font-medium">
            ...
            <tr class="hover:bg-gray-50 transition-colors">
              <td class="px-5 py-3.5">
                <div class="flex items-center gap-3">
                  ...
                  <div>
                    <a href="/crm/clients/view?id=<?= $cl['id'] ?>"
              ...
              <td class="px-4 py-3.5 text-right">
                <div class="flex items-center justify-end gap-2">
                  ...
                  <a href="/crm/clients/edit?id=<?= $cl['id'] ?>"
